...
3-2 ボードの設定を変える．Hobby RPN に近い動作条件の Arduino Fio を選ぶ．また，<b>書き込み装置として "Arduino as ISP" を選んでおく</b>．シリアルポートは同じポートとなる．

<img src="https://user-images.githubusercontent.com/86639425/126645158-caf09145-c7d3-474d-853d-d57020454025.jpg" width="600">

3-3 メニューから<b>「書込装置を使って書き込む」を用いて書き込みを行う</b>．画面の書き込みボタンは使えない．
